...
for iyear in range(23,42):
  ...
  ##--##--##--##--  read 90th threshold   --##--##--##--##
  ds1 = xr.open_dataset("/public/home/fcai/extreme5_degree/25_humid_heat/2_network/part3_wbt95_qs95_NH/threshold/ERA5_qs95_JJA_1982_2023.nc")
  qs95 = ds1.qs95[iyear,:,:,:]
  ...
  ds0.to_netcdf("/public/home/fcai/extreme5_degree/25_humid_heat/2_network/part11_qs95_qs95_NH/qs95_qs95_NH2x2_"+str(iyear+1982)+".nc")
  ds0.close()
