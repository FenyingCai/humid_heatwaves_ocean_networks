...
ds1 = xr.open_dataset("1_threshold/topo_2x2.nc")
...
for iyear in range(0,42):
  ...
  ##--##--##--##--  read 90th threshold   --##--##--##--##
  ds1 = xr.open_dataset("2_networks/part1_wbt95_sst95_NH/threshold/ERA5_wbt95_JJA_1982_2023.nc")
  wbt95 = ds1.wbt95[iyear,:,:,:]
  

  ds2 = xr.open_dataset("2_networks/part1_wbt95_sst95_NH/threshold/OISST_sst95_JJA_1982_2023.nc")
  ...
  ds0.to_netcdf("2_networks/part1_wbt95_sst95_NH/wbt95_sst95_NH2x2_"+str(iyear+1982)+".nc")
  ds0.close()
