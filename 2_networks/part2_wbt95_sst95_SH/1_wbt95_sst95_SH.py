...
for iyear in range(0,42):
  ...
  ##--##--##--##--  read 90th threshold   --##--##--##--##
  ds1 = xr.open_dataset("/public/home/fcai/extreme5_degree/25_humid_heat/2_network/part31_wbt95_sst95_NH/threshold/ERA5_wbt95_DJF_1982_2023.nc")
  wbt95 = ds1.wbt95[iyear,:,:,:]
  

  ds2 = xr.open_dataset("/public/home/fcai/extreme5_degree/25_humid_heat/2_network/part31_wbt95_sst95_NH/threshold/OISST_sst95_DJF_1982_2023.nc")
  sst95 = ds2.sst95[iyear,:,:,:]
  ...
  for alat in range(np.shape(wbt95)[1]):
    ...
    for alon in range(np.shape(wbt95)[2]):
      ...
      concurrent_days = np.sum(t_True_3D[:,:,:]+sst95[:,:,:]==2,axis=0)
  ...
  ds0.to_netcdf("/public/home/fcai/extreme5_degree/25_humid_heat/2_network/part32_wbt95_sst95_SH/wbt95_sst95_SH2x2_"+str(iyear+1982)+".nc")
  ds0.close()
