...
for iyear in range(0,42):
  ...
  ##--##--##--##--  read 90th threshold   --##--##--##--##
  ds1 = xr.open_dataset("/public/home/fcai/extreme5_degree/25_humid_heat/2_network/part1_wbt95_sst95_NH/threshold/ERA5_wbt95_DJF_1982_2023.nc")
  ...
  ds0.to_netcdf("/public/home/fcai/extreme5_degree/25_humid_heat/2_network/part4_wbt95_qs95_SH/wbt95_qs95_SH2x2_"+str(iyear+1982)+".nc")
  ds0.close()
