...
##--##--##--##--##--##--      --##--##--##--##--##--##
ds1 = xr.open_dataset("/public/home/fcai/extreme5_degree/25_humid_heat/2_network/part7_wbt95_wbt95_NH/distance_PDF_1982_2023_wbt95_wbt95_NH.nc")
pdf1_NH = (ds1.pdf.data)
ref1_NH = (ds1.ref.data)
pdf_ref1_NH = (ds1.pdf_ref.data)

ds2 = xr.open_dataset("/public/home/fcai/extreme5_degree/25_humid_heat/2_network/part8_wbt95_wbt95_SH/distance_PDF_1982_2023_wbt95_wbt95_SH.nc")
...
ax3 = plt.axes([0.01,0.4, 0.27,0.15])
create_map(ax3)
ax3.tick_params(axis='both', length=5.0, width=1.0, labelsize=9.5)
ax3.set_xlabel('Distance  (x1000 km)', size=11.0)
ax3.set_ylabel('Proportion', size=11.0)
plt.ylim(0.0,1.0)
ax3.set_yticks(np.linspace(0.0,1.0,11)); ax3.set_yticklabels(["0","","20%","","40%","","60%","","80%","","100%"], color='black')
...
ax3.legend(loc=(0.48, 0.43), fontsize=9.5, frameon=False)
ax3.set_title('Wbt   &   Wbt', fontsize=11.0, color='black')




ax5 = plt.axes([0.31,0.4, 0.27,0.15])
create_map(ax5)
ax5.tick_params(axis='both', length=5.0, width=1.0, labelsize=9.5)
ax5.set_xlabel('Distance  (x1000 km)', size=11.0)
ax5.set_ylabel('', size=10.5)
plt.ylim(0.0,1.0)
ax5.set_yticks(np.linspace(0.0,1.0,11)); ax5.set_yticklabels(["","","","","","","","","","",""], color='black')
ax5.plot(x[1:41], pdf_ref2_NH[1:41], label='NH', color='#2b2a76', markerfacecolor='#2b2a76', markeredgecolor='#2b2a76', markeredgewidth=0.0, linewidth=0.8,  markersize=0.0, linestyle='-')
ax5.plot(x[1:41], pdf_ref2_SH[1:41], label='SH', color='#009E74', markerfacecolor='#009E74', markeredgecolor='#a21d2f', markeredgewidth=0.0, linewidth=0.8,  markersize=0.0, linestyle='-')
ax5.plot(x[1:41], pdf_ref2[1:41], label='Globe', color='#B83945', markerfacecolor='#DB9BA1', markeredgecolor='#B83945', marker='o', markeredgewidth=0.8, linewidth=0.7,  markersize=4.5, linestyle='-')
ax5.legend(loc=(0.48, 0.43), fontsize=9.5, frameon=False)
ax5.set_title('Wbt   &   Wet', fontsize=11.0, color='black')
...
fig.savefig('/public/home/fcai/extreme5_degree/25_humid_heat/3_analysis1982_2023/Figure1b_distance_pdf.png', bbox_inches = 'tight')
plt.show()
